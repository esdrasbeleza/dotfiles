...
install_cli_tools() {
    ...
    sudo pacman -S  --noconfirm the_silver_searcher tmux vim neovim jq direnv ttf-hack-nerd git shellcheck ripgrep fd sqlite python lua stylua lua-language-server zoxide eza bat git-delta lazygit starship
}
