...
install_cli_tools() {
    ...
    brew install the_silver_searcher font-hack-nerd-font tmux vim nvim jq direnv git shellcheck ripgrep fd sqlite lua stylua lua-language-server python3 zoxide
}
